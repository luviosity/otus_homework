...
from homework_05.db import get_db, MockDB
from homework_05.schemas import Book, BookCreate, BookGenre
from pydantic import ValidationError
from typing import Annotated

router = APIRouter()
templates = Jinja2Templates(directory="homework_05/templates")
...
async def book_create(
    ...
    try:
        ...
        return RedirectResponse(url=f"/{book_id}/", status_code=status.HTTP_303_SEE_OTHER)
